"""
Django settings for chainpesa project.
...
SECRET_KEY = 'django-insecure--!w%982d31rww0v*98+=!0f^=qzo2pdfhw&xr%lnxtd=4^uec8'
...
WSGI_APPLICATION = 'chainpesa.wsgi.application'
